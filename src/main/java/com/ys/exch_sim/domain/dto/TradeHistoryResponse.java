...
public class TradeHistoryResponse {
    ...
    public static class TradeHistoryDto {
        ...
        public TradeHistoryDto(String execID, String symbol, String side, long quantity, 
                              double price, double amount, String counterPartyUsername, 
                              LocalDateTime timestamp, String clOrdID) {
            this.execID = execID;
            this.symbol = symbol;
            this.side = side;
